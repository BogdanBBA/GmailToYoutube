...
namespace GmailToYoutube
{
    ...
    public class Settings
    {
        ...
        public bool HideWindowInsteadOfAltTabbing { get; set; }
        ...
        public void LoadFromXmlNode(XmlNode settingsNode)
        {
            ...
            try
            { this.HideWindowInsteadOfAltTabbing = bool.Parse(settingsNode.SelectSingleNode("HideWindowInsteadOfAltTabbing").Attributes["value"].Value); }
            catch (Exception) { this.HideWindowInsteadOfAltTabbing = false; }
        ...
        public XmlNode SaveToXmlNode(XmlDocument doc)
        {
            ...
            node = root.AppendChild(doc.CreateElement("HideWindowInsteadOfAltTabbing"));
            node.AddAttribute(doc, "value", this.HideWindowInsteadOfAltTabbing.ToString());
