        ...
        public Size VisibleSize
        {
            get
            {
                return this.scrollBar.Position == MyScrollBar.ScrollBarPosition.Right
                    ? new Size(this.containerPanel.Width - this.scrollBarWidth, this.containerPanel.Height)
                    : new Size(this.containerPanel.Width, this.containerPanel.Height - this.scrollBarWidth);
            }
        }
